...
with mobile Lightning Network clients in mind. It uses a
...
saved. There are multiple
[known major issues](https://github.com/lightninglabs/neutrino/issues) with the
client, so it is **not recommended** to use it with real money at this point.
...
contract platform such as a
[Lightning Network node like `lnd`](https://github.com/lightningnetwork/lnd).
...
[btcjson](https://github.com/pkt-cash/pktd/blob/master/btcjson/chainsvrwsntfns.go)
